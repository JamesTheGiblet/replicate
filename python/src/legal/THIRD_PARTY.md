...
Explorer-d334 includes or depends on the following open source software:
...
## Watchdog
- **License:** Apache 2.0
- **Copyright:** Yesudeep Mangalapilly
...
**This software includes third-party components. Their licenses are respected.**
